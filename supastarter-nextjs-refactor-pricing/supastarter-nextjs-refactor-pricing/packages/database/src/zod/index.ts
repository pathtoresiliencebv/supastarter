...
export const PurchaseScalarFieldEnumSchema = z.enum(['id','teamId','customerId','type','status','priceId','nextPaymentDate','userId']);
...
export const PurchaseTypeSchema = z.enum(['ONE_TIME','SUBSCRIPTION']);
